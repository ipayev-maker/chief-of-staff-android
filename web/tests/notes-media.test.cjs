...
function harness(){
 ...
 vm.runInContext(script+'\n;globalThis.T={S,createNote,noteState,syncNoteInputs,persistNote,flushNote,deleteNote,restoreNote,fullSignedUrl,assetMime,assetPreview,signAsset,uploadNoteFiles,notesPage:legacyNotesPage,MEDIA_MIMES};',ctx);
